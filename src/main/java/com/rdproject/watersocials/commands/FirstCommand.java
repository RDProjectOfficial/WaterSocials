...
public class FirstCommand extends Command {
    ...
    public FirstCommand() {
        super(cg.getString("SocialCommands.one"), cg.getString("Permissions.one"), cg.getString("SocialAliases.one"));
    }
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        system.setText(cg.getString("Prefix") + cg.getString("SocialMessages.one"));
        system.setClickEvent(new ClickEvent(ClickEvent.Action.OPEN_URL, cg.getString("SocialURLs.one")));
